# Comparing `tmp/stigg_api_client-0.445.0.tar.gz` & `tmp/stigg_api_client-0.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "stigg_api_client-0.445.0.tar", max compression
+gzip compressed data, was "stigg_api_client-0.5.0.tar", max compression
```

## Comparing `stigg_api_client-0.445.0.tar` & `stigg_api_client-0.5.0.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     2479 2023-05-28 11:05:26.138100 stigg_api_client-0.445.0/README.md
--rw-r--r--   0        0        0      460 2023-05-28 11:06:08.994690 stigg_api_client-0.445.0/pyproject.toml
--rw-r--r--   0        0        0       44 2023-05-28 11:05:26.138100 stigg_api_client-0.445.0/stigg/__init__.py
--rw-r--r--   0        0        0     1141 2023-05-28 11:05:26.138100 stigg_api_client-0.445.0/stigg/client.py
--rw-r--r--   0        0        0        0 2023-05-28 11:06:06.666660 stigg_api_client-0.445.0/stigg/generated/__init__.py
--rw-r--r--   0        0        0    46357 2023-05-28 11:06:07.158666 stigg_api_client-0.445.0/stigg/generated/operations.py
--rw-r--r--   0        0        0   458008 2023-05-28 11:06:06.970664 stigg_api_client-0.445.0/stigg/generated/schema.py
--rw-r--r--   0        0        0     3117 1970-01-01 00:00:00.000000 stigg_api_client-0.445.0/PKG-INFO
...
### Comparing `stigg_api_client-0.445.0/README.md` & `stigg_api_client-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `stigg_api_client-0.445.0/stigg/client.py` & `stigg_api_client-0.5.0/stigg/client.py`

 * *Files identical despite different names*

### Comparing `stigg_api_client-0.445.0/stigg/generated/operations.py` & `stigg_api_client-0.5.0/stigg/generated/operations.py`
...
### Comparing `stigg_api_client-0.445.0/stigg/generated/schema.py` & `stigg_api_client-0.5.0/stigg/generated/schema.py`
...
### Comparing `stigg_api_client-0.445.0/PKG-INFO` & `stigg_api_client-0.5.0/PKG-INFO`
