# Comparing `tmp/mosaic-library-0.0.9.tar.gz` & `tmp/mosaic-library-1.0.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mosaic-library-0.0.9.tar", last modified: Thu Jun 16 12:59:19 2022, max compression
+gzip compressed data, was "mosaic-library-1.0.0.tar", last modified: Sun May 28 14:05:53 2023, max compression
```

## Comparing `mosaic-library-0.0.9.tar` & `mosaic-library-1.0.0.tar`

### file list

```diff
@@ -1,19 +1,22 @@
-drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2022-06-16 12:59:19.342052 mosaic-library-0.0.9/
--rw-rw-r--   0 fft       (1000) fft       (1000)       81 2022-06-16 12:59:19.342052 mosaic-library-0.0.9/PKG-INFO
-drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2022-06-16 12:59:19.338052 mosaic-library-0.0.9/mosaic_library.egg-info/
--rw-rw-r--   0 fft       (1000) fft       (1000)       81 2022-06-16 12:59:18.000000 mosaic-library-0.0.9/mosaic_library.egg-info/PKG-INFO
--rw-rw-r--   0 fft       (1000) fft       (1000)      429 2022-06-16 12:59:19.000000 mosaic-library-0.0.9/mosaic_library.egg-info/SOURCES.txt
--rw-rw-r--   0 fft       (1000) fft       (1000)        1 2022-06-16 12:59:18.000000 mosaic-library-0.0.9/mosaic_library.egg-info/dependency_links.txt
--rw-rw-r--   0 fft       (1000) fft       (1000)       53 2022-06-16 12:59:18.000000 mosaic-library-0.0.9/mosaic_library.egg-info/entry_points.txt
--rw-rw-r--   0 fft       (1000) fft       (1000)       79 2022-06-16 12:59:19.000000 mosaic-library-0.0.9/mosaic_library.egg-info/requires.txt
--rw-rw-r--   0 fft       (1000) fft       (1000)       11 2022-06-16 12:59:19.000000 mosaic-library-0.0.9/mosaic_library.egg-info/top_level.txt
-drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2022-06-16 12:59:19.342052 mosaic-library-0.0.9/mosaicking/
--rw-rw-r--   0 fft       (1000) fft       (1000)        0 2021-06-12 17:59:45.000000 mosaic-library-0.0.9/mosaicking/__init__.py
--rw-rw-r--   0 fft       (1000) fft       (1000)     2221 2021-06-20 14:52:59.000000 mosaic-library-0.0.9/mosaicking/calibration.py
--rw-rw-r--   0 fft       (1000) fft       (1000)    22538 2022-03-13 15:24:07.000000 mosaic-library-0.0.9/mosaicking/mosaic.py
--rw-rw-r--   0 fft       (1000) fft       (1000)     2836 2022-06-15 14:01:21.000000 mosaic-library-0.0.9/mosaicking/preprocessing.py
--rw-rw-r--   0 fft       (1000) fft       (1000)    12901 2022-03-13 15:24:07.000000 mosaic-library-0.0.9/mosaicking/registration.py
--rw-rw-r--   0 fft       (1000) fft       (1000)    15664 2022-03-13 15:24:07.000000 mosaic-library-0.0.9/mosaicking/transformations.py
--rw-rw-r--   0 fft       (1000) fft       (1000)    11228 2022-03-13 15:24:07.000000 mosaic-library-0.0.9/mosaicking/utils.py
--rw-rw-r--   0 fft       (1000) fft       (1000)       89 2021-06-18 15:24:15.000000 mosaic-library-0.0.9/pyproject.toml
--rw-rw-r--   0 fft       (1000) fft       (1000)      375 2022-06-16 12:59:19.342052 mosaic-library-0.0.9/setup.cfg
+drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2023-05-28 14:05:53.703136 mosaic-library-1.0.0/
+-rw-rw-r--   0 fft       (1000) fft       (1000)     1083 2023-05-28 13:14:18.000000 mosaic-library-1.0.0/LICENSE
+-rw-rw-r--   0 fft       (1000) fft       (1000)      103 2023-05-28 14:05:53.703136 mosaic-library-1.0.0/PKG-INFO
+drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2023-05-28 14:05:53.703136 mosaic-library-1.0.0/mosaic_library.egg-info/
+-rw-rw-r--   0 fft       (1000) fft       (1000)      103 2023-05-28 14:05:53.000000 mosaic-library-1.0.0/mosaic_library.egg-info/PKG-INFO
+-rw-rw-r--   0 fft       (1000) fft       (1000)      465 2023-05-28 14:05:53.000000 mosaic-library-1.0.0/mosaic_library.egg-info/SOURCES.txt
+-rw-rw-r--   0 fft       (1000) fft       (1000)        1 2023-05-28 14:05:53.000000 mosaic-library-1.0.0/mosaic_library.egg-info/dependency_links.txt
+-rw-rw-r--   0 fft       (1000) fft       (1000)       98 2023-05-28 14:05:53.000000 mosaic-library-1.0.0/mosaic_library.egg-info/entry_points.txt
+-rw-rw-r--   0 fft       (1000) fft       (1000)       86 2023-05-28 14:05:53.000000 mosaic-library-1.0.0/mosaic_library.egg-info/requires.txt
+-rw-rw-r--   0 fft       (1000) fft       (1000)       11 2023-05-28 14:05:53.000000 mosaic-library-1.0.0/mosaic_library.egg-info/top_level.txt
+drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2023-05-28 14:05:53.703136 mosaic-library-1.0.0/mosaicking/
+-rw-rw-r--   0 fft       (1000) fft       (1000)        0 2023-05-19 14:29:07.000000 mosaic-library-1.0.0/mosaicking/__init__.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)     5067 2023-05-27 18:05:33.000000 mosaic-library-1.0.0/mosaicking/calibration.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)    22678 2023-05-27 15:19:30.000000 mosaic-library-1.0.0/mosaicking/mosaic.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)     6135 2023-05-28 08:31:11.000000 mosaic-library-1.0.0/mosaicking/preprocessing.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)     2156 2023-05-28 05:54:24.000000 mosaic-library-1.0.0/mosaicking/registration.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)    16557 2023-05-28 08:28:15.000000 mosaic-library-1.0.0/mosaicking/transformations.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)    11706 2023-05-26 00:02:02.000000 mosaic-library-1.0.0/mosaicking/utils.py
+-rw-rw-r--   0 fft       (1000) fft       (1000)       89 2023-05-19 14:29:07.000000 mosaic-library-1.0.0/pyproject.toml
+-rw-rw-r--   0 fft       (1000) fft       (1000)      427 2023-05-28 14:05:53.703136 mosaic-library-1.0.0/setup.cfg
+drwxrwxr-x   0 fft       (1000) fft       (1000)        0 2023-05-28 14:05:53.703136 mosaic-library-1.0.0/tests/
+-rw-rw-r--   0 fft       (1000) fft       (1000)     2727 2023-05-27 15:29:36.000000 mosaic-library-1.0.0/tests/test_preprocessing.py
```

### Comparing `mosaic-library-0.0.9/mosaicking/mosaic.py` & `mosaic-library-1.0.0/mosaicking/mosaic.py`
...
### Comparing `mosaic-library-0.0.9/mosaicking/transformations.py` & `mosaic-library-1.0.0/mosaicking/transformations.py`
...
### Comparing `mosaic-library-0.0.9/mosaicking/utils.py` & `mosaic-library-1.0.0/mosaicking/utils.py`
