# Comparing `tmp/chatcmd-1.0.46.tar.gz` & `tmp/chatcmd-1.0.47.tar.gz`
...
## Comparing `chatcmd-1.0.46.tar` & `chatcmd-1.0.47.tar`
...
### Comparing `chatcmd-1.0.46/LICENSE` & `chatcmd-1.0.47/LICENSE`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.46/PKG-INFO` & `chatcmd-1.0.47/PKG-INFO`
...
### Comparing `chatcmd-1.0.46/README.md` & `chatcmd-1.0.47/README.md`
...
### Comparing `chatcmd-1.0.46/chatcmd/api.py` & `chatcmd-1.0.47/chatcmd/api.py`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.46/chatcmd/chatcmd.py` & `chatcmd-1.0.47/chatcmd/chatcmd.py`
...
### Comparing `chatcmd-1.0.46/chatcmd/commands.py` & `chatcmd-1.0.47/chatcmd/commands.py`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.46/chatcmd/helpers.py` & `chatcmd-1.0.47/chatcmd/helpers.py`
...
+        subprocess.run(['/usr/bin/xsel', '-i', '-b'], input=text, encoding='utf-8', check=True)
...
### Comparing `chatcmd-1.0.46/chatcmd/lookup.py` & `chatcmd-1.0.47/chatcmd/lookup.py`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.46/chatcmd.egg-info/PKG-INFO` & `chatcmd-1.0.47/chatcmd.egg-info/PKG-INFO`
...
### Comparing `chatcmd-1.0.46/pyproject.toml` & `chatcmd-1.0.47/pyproject.toml`
...
### Comparing `chatcmd-1.0.46/setup.py` & `chatcmd-1.0.47/setup.py`
