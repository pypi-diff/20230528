# Comparing `tmp/v_quantum_annealing-0.0.0.tar.gz` & `tmp/v_quantum_annealing-1.0.0.tar.gz`
...
### Comparing `v_quantum_annealing-0.0.0/cmake/PythonAutoDetectOSX.cmake` & `v_quantum_annealing-1.0.0/cmake/PythonAutoDetectOSX.cmake`
...
### Comparing `v_quantum_annealing-0.0.0/setup.py` & `v_quantum_annealing-1.0.0/setup.py`
...
### Comparing `v_quantum_annealing-0.0.0/tests/cxxtest/graph/polynomial.hpp` & `v_quantum_annealing-1.0.0/tests/cxxtest/graph/polynomial.hpp`
...
### Comparing `v_quantum_annealing-0.0.0/tests/test_model.py` & `v_quantum_annealing-1.0.0/tests/test_model.py`
...
### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/chimera_gpu/base_gpu_chimera.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/chimera_gpu/base_gpu_chimera.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/chimera_gpu/gpu_sa_sampler.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/chimera_gpu/gpu_sa_sampler.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/chimera_gpu/gpu_sqa_sampler.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/chimera_gpu/gpu_sqa_sampler.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/csqa_sampler.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/csqa_sampler.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/response.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/response.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/sa_sampler.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/sa_sampler.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/sampler.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/sampler.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/sampler/sqa_sampler.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/sampler/sqa_sampler.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/utils/__init__.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/utils/benchmark.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/utils/benchmark.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/utils/cxx_cast.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/utils/cxx_cast.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/utils/decorator.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/utils/decorator.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/utils/graph_utils.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/utils/graph_utils.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/utils/res_convertor.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/utils/res_convertor.py`

 * *Files identical despite different names*

### Comparing `v_quantum_annealing-0.0.0/v_quantum_annealing/variable_type.py` & `v_quantum_annealing-1.0.0/v_quantum_annealing/variable_type.py`
