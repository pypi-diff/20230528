# Comparing `tmp/docker-recipe-0.1.2.tar.gz` & `tmp/docker-recipe-0.1.3.tar.gz`
...
## Comparing `docker-recipe-0.1.2.tar` & `docker-recipe-0.1.3.tar`
...
### Comparing `docker-recipe-0.1.2/LICENSE.md` & `docker-recipe-0.1.3/LICENSE.md`

 * *Files identical despite different names*

### Comparing `docker-recipe-0.1.2/PKG-INFO` & `docker-recipe-0.1.3/PKG-INFO`
...
### Comparing `docker-recipe-0.1.2/docker_recipe.egg-info/PKG-INFO` & `docker-recipe-0.1.3/docker_recipe.egg-info/PKG-INFO`
...
### Comparing `docker-recipe-0.1.2/setup.py` & `docker-recipe-0.1.3/setup.py`
